...
public class RegistreTemperatures_PART2 {
  ...
  public void calculaDiferencia() {
    //Aquesta és la funció que vosaltres heu de programar.
  }
  public void calcularDiferenciaMaxima() {
    float mayor = temperatures[0];
    float menor = temperatures[0];
    ...
    for(int i = 0; i < temperatures.length; i++){
      ...
      else if(temperatures[i] < menor){
        menor = temperatures[i];
      }
      float diferencia = menor - mayor;
